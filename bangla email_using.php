		...
		<div class="stracture header fix">
		 <div class="icon_add floatleft">
		   <a href=""> <img src="image/icon.jpg" alt="" />
			...
			<a href="../email_using.php"><h5>English</h5></a>
		 </div>
   ...
   <div class="login_area fix">
	...
	<div class="mid_login fix">
	   <a href=""><h1><i class="fa fa-facebook-official">  &nbsp;ফেসবুকের  সঙ্গে চলুক</i></h1></a>
	                       <h5>অথবা</h5>
	   <input type="text" placeholder="নাম" name="email" required="1" />
	   <input type="email" placeholder="ইমেইল" name="email" required="1" />
	   <input type="password" placeholder="পাসওয়ার্ড" name="email" required="1" />
	   <input type="password"  placeholder="পাসওয়ার্ড নিশ্চিত করুন" name="password" required="1"/>
		<a href="bangla upto_log_in.php"><h3>সাইন  আপ </h3></a>
					<hr>
